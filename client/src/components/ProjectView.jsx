        ...
        <div className='bg-white p-2 w-full shadow-lg z-10'>
            <div className='grid grid-cols-4'>
                ...
                <div className='mx-2'>
                    ...
                    <p className='text-l text-gray-800 font-semibold'> Bryan Ron Hernandez</p>
                </div>
                ...
                {/* Progress Bar */}
                    <div className="flex items-center">
                        <div className="mx-1 flex flex-col items-center">
                            <span className="text-l text-blue-600 font-semibold mb-1">{progress === 100 ? 'Done' : 'Progress'}</span>
                            <div className="relative">
                                <div className="w-44 h-10 overflow-hidden rounded-full bg-gray-200 shadow-lg">
                                    <div className={`h-full ${progress === 100 ? 'bg-green-500' : 'bg-blue-300'}`} style={{width: `${progress}%`, transition: 'width 0.5s ease'}}>
                                        {progress === 100 ? (
                                            ...
                                            <span className="absolute inset-0 flex items-center justify-center text-xs text-blue-600">{progress}%</span>
                                        )}
                                    </div>
                                </div>
                            </div>
                ...
                <div className="flex items-center">
                  <div className="mx-1 flex flex-col items-center">
                    ...
                    <div className="relative">
                      <div className="w-44 h-10 overflow-hidden rounded-full bg-gray-200 shadow-lg">
                        <div className={`h-full bg-blue-300 ${getWeightBackgroundColor()}`} style={{width: `${weight}%`, transition: 'width 0.5s ease'}}>
                          <span className="absolute inset-0 flex items-center justify-center text-xs text-blue-600 font-semibold">{weight}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
